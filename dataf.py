...
def main():
	...
	# print(len(locale.wv.vocab.keys()))
	# print(locale.wv.vocab.kkeyseys())
	# print (locale.wv['Tokyo-to'])

	#temp = list(zip(date,time,src_port,dst_port,ips,proto,country,locale))
